...
import 'package:newsapp/searchnewspage.dart';
import 'package:newsapp/widget/sortbyenum.dart';
                    ...
                    child: Container(
                      ...
                      child: DropdownButton<String>(
                        ...
                        items: [
                          ...
                          DropdownMenuItem(
                            value: NewsEnum.relevency.name,
                            child: Container(
                              width: MediaQuery.of(context).size.width * 0.2,
                              padding: const EdgeInsets.all(8.0),
                              child: Text(
                                NewsEnum.relevency.name,
                                style: const TextStyle(
                                    fontSize: 12, fontWeight: FontWeight.w500),
                              ),
                            ),
